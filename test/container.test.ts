...
import { Constructable, Container, ContextComponent, ContextComponentNotFoundError, Token } from '../src'
...
describe('Container', function () {
  ...
  describe('remove', function () {
    it('should be able to remove previously registered services', function () {
      ...
      expect(Container.get(TestService)).toBe(testService)
      expect(() => Container.get<TestService>('test1-service')).toThrowError(ContextComponentNotFoundError)
      expect(() => Container.get<TestService>('test2-service')).toThrowError(ContextComponentNotFoundError)
    })
  })
  ...
  describe('Container.remove', () => {
    it('should call dispose function on removed service', () => {
      ...
      expect(() => Container.get(MyServiceA)).toThrowError(ContextComponentNotFoundError)
      expect(() => Container.get(MyServiceB)).toThrowError(ContextComponentNotFoundError)
    })
    ...
    it('should be able to destroy services without destroy function', () => {
      ...
      expect(() => Container.get(MyService)).toThrowError(ContextComponentNotFoundError)
    })
  })
})
